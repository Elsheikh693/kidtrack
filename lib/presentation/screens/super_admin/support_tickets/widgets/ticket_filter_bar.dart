...
class TicketFilterBar extends StatelessWidget {
  ...
  const TicketFilterBar({super.key, required this.controller});
          ...
          return Obx(() {
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Text('ticket_status_$s'.tr, style: context.typography.xsMedium.copyWith(fontSize: 13, color: active ? Colors.white : const Color(0xFF475569))),
              ),
            );
          });
        },
