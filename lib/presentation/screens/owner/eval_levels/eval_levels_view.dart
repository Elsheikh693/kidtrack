...
class EvalLevelsView extends StatefulWidget {
  const EvalLevelsView({super.key});

  @override
  State<EvalLevelsView> createState() => _EvalLevelsViewState();
}

class _EvalLevelsViewState extends State<EvalLevelsView> {
  late final EvalLevelsController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.find<EvalLevelsController>();
  }
