...
class _WaitingSheetState extends State<WaitingSheet> with KeyboardSheetMixin {
  ...
  String _statusLabel(String s) {
    switch (s) {
      case 'pending':
        return 'waiting_status_pending'.tr;
      case 'contacted':
        return 'waiting_status_contacted'.tr;
      case 'enrolled':
        return 'waiting_status_enrolled'.tr;
      default:
        return 'waiting_status_cancelled'.tr;
    }
  }
  ...
  Future<void> _submit() async {
    ...
    if (childName.isEmpty) {
      Loader.showError('waiting_error_child_name'.tr);
      return;
    }
    if (parentName.isEmpty) {
      Loader.showError('waiting_error_parent_name'.tr);
      return;
    }
    if (parentPhone.isEmpty) {
      Loader.showError('waiting_error_parent_phone'.tr);
      return;
    }
    ...
    if (isEdit) {
      await _service.update(
        ...
        callBack: (s) {
          ...
          if (s == ResponseStatus.success) {
            Loader.showSuccess('waiting_success_updated'.tr);
            Get.back();
          } else
      ...
      await _service.add(
        ...
        callBack: (s) {
          Loader.dismiss();
          if (s == ResponseStatus.success) {
            Loader.showSuccess('waiting_success_added'.tr);
            Get.back();
          } else
            Loader.showError('waiting_error_failed'.tr);
        },
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                isEdit ? 'waiting_edit_title'.tr : 'waiting_add_title'.tr,
              ...
              _Field(
                ...
                hint: 'waiting_child_name_hint'.tr,
              ),
              ...
              _Field(
                ...
                hint: 'waiting_parent_name_hint'.tr,
              ),
              SizedBox(height: 16.h),
              ...
              _Field(
                ...
                hint: 'waiting_parent_phone_hint'.tr,
                  ...
                  children: _statuses.map((s) {
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          _statusLabel(s),
                          style: ctx.typography.xsMedium.copyWith(
                            fontSize: 13,
                            color: isSelected
                                ? Colors.white
