...
/// Loading skeleton for the Finance tab — mirrors the real layout (KPI grid,
/// collection risk, outstanding families, invoices directory) so the
/// transition into loaded content has no layout shift.
